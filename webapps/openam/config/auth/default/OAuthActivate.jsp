...
<%@ page import="org.owasp.esapi.ESAPI" %>
<%@ page import="com.sun.identity.authentication.client.AuthClientUtils" %>
<%@ page import="org.forgerock.openam.shared.security.crypto.Fingerprints" %>
...
<%
    ...
    String authCookie = AuthClientUtils.getAuthCookieValue(request);
    String formToken = authCookie == null ? null : Fingerprints.generate(authCookie);
%>
...
<div class="container_12">
            ...
            <div class="box-content clear-float">
                ...
                <form name="Login" method="POST" action="<%= emptyField %>"
                    ...
                    <fieldset>
                        ...
                        <input type="hidden" name="frmToken" value="<%= formToken %>"/>
                    </fieldset>
                </form>
            </div>
        </div>
    ...
    <div class="footer alt-color">
        <div class="grid_3">
            <p>Copyright &copy; 2008-2020, ForgeRock AS. <br/>All Rights Reserved. Use of this software is subject to the
