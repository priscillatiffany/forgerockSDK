    ...
    background-repeat:repeat-x;background-position:left top;">
      ...
      <td>
        <div class="logCpy"><span class="logTxtCpy">
          Copyright &copy; 2008-2020, ForgeRock AS. All Rights Reserved. Use of this software is subject to the terms and conditions of the ForgeRock&#8482; License and Subscription Agreement.
        </div>
      </td>
      <td>&nbsp;</td>
    </tr>
