...
public final class SA_005fIDP_jsp extends org.apache.jasper.runtime.HttpJspBase
        ...
        try {
            ...
            while (iter.hasNext()) {
                ...
                if (mm.isTrustedProvider(realm, idpEntityId, tempspId)) {
                    ...
                    SPSSODescriptorType spDesc =
                        mm.getSPSSODescriptor(realm, tempspId);
                    for (IndexedEndpointType assertionConsumerServiceElement : spDesc.getAssertionConsumerService()) {
                        if (assertionConsumerServiceElement.getLocation().contains(targetHost)) {
                            return tempspId;
                        }
                    }
                }
  ...
  static {
    ...
    _jspx_imports_classes.add("org.forgerock.openam.utils.ClientUtils");
    ...
    _jspx_imports_classes.add("com.sun.identity.sae.api.Utils");
    ...
    _jspx_imports_classes.add("com.sun.identity.saml2.jaxb.metadata.SPSSODescriptorType");
    _jspx_imports_classes.add("com.sun.identity.saml2.jaxb.metadata.IndexedEndpointType");
